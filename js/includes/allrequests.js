...
var myfunc = async function(obj) {
  ...
  try {
    ...
    if(decrypted.data) {
      ...
      var sql = "SELECT *,round(extract(epoch from cashout_updatestamp) * 1000) as updatestamp FROM tbl_cashout WHERE cashout_status=0 ORDER BY cashout_id DESC";
      ...
      if(res&&res.rows&&res.rows.length) {
        ...
        var retdata = {success:1, allrequests: res.rows}
