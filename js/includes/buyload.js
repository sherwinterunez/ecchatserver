...
var myfunc = async function(obj) {
  ...
  try {
    ...
    if(decrypted.data) {
      ...
      content['transaction_fundfromfullname'] = sessionData.fullname;
      ...
      var content = {};
  		...
  		content['buyload_userid'] = sessionData.user_id;
  		content['buyload_userlogin'] = sessionData.user_login;
  		content['buyload_usertype'] = sessionData.user_type;
